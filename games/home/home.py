...
from games.genreBar.services import get_genres
...
#                     found_games.append(game)
#     return render_template('search/gameSearchBarResult.html', search_query=search, games=found_games, all_genres=all_genres)